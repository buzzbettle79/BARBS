...
dotfilesrepo="https://github.com/buzzbettle79/dotfiles.git"
progsfile="https://raw.githubusercontent.com/buzzbettle79/BARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to BuzzBettle's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
...
# Currently commented out as throws error during install, TODO Debug
# vimplugininstall() {
...
installffaddons(){
	addonlist="ublock-origin vim-vixen"
	addontmp="$(mktemp -d)"
